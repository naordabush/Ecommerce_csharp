...
namespace lezioniEcommerce.API.Migrations
{
    ...
    [Migration("20240327141815_USERS_fix_length_password")]
    partial class USERS_fix_length_password
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lezioniEcommerce.API.DataModel.PRODUCTS_CATEGORIES", b =>
                {
                    b.HasOne("lezioniEcommerce.API.DataModel.CATEGORIES", "CATEGORIES")
                        .WithMany()
                        .HasForeignKey("CATEGORY_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("lezioniEcommerce.API.Controllers.DataModel.PRODUCTS", "PRODUCTS")
                        .WithMany()
                        .HasForeignKey("PRODUCT_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
